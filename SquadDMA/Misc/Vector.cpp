...
Vector3 Vector3::ToAngles(Vector3 a)
{
    Vector3 ang;

    float xy = std::sqrt(a.x * a.x + a.y * a.y);
    ang.x = (std::atan2(-a.z, xy) * 180 / 3.14159265358979323846f) + 360.0f;

    ang.y = std::atan2(a.y, a.x) * 180 / 3.14159265358979323846f;
